    ...
    >
      ...
      {isMenuOpen && (
        <div className="sm:hidden w-full bg-[#3b4799] py-4 flex flex-col items-center gap-4 transition-all duration-200 ease-in-out">
          ...
          <Link to="/estudiante/notas" className="text-white text-lg font-medium hover:text-blue-200 transition-colors">
            Notas
          </Link>
          <Link to="/estudiante/calendario" className="text-white text-lg font-medium hover:text-blue-200 transition-colors">
            Calendario
          </Link>
          <Link to="/estudiante/asistencia" className="text-white text-lg font-medium hover:text-blue-200 transition-colors">
            Asistencia
          </Link>
        </div>
      )}
