  ...
  return (
    ...
    >
      ...
      <div className="hidden sm:flex w-full items-center justify-between px-8 md:px-16 lg:px-24">
        <div className="flex-1 flex justify-start items-center relative z-10">
          <Link
            to="/"
        ...
        <div className="flex-1 flex justify-end items-center z-10">
          <nav className="relative z-10 flex items-center gap-4 md:gap-6 flex-wrap justify-center font-medium text-lg md:text-xl">
